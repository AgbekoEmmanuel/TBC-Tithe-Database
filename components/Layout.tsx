...
export const Layout: React.FC = () => {
  ...
  return (
    <div className="flex min-h-screen md:h-screen bg-[#1e1e2d]">
      ...
      <div className="md:hidden fixed top-0 left-0 w-full bg-white z-50 h-14 border-b border-gray-100 flex items-center justify-between px-4 transition-all duration-300 shadow-sm">
        {/* Left: Logo */}
      ...
      <div className="flex-1 min-h-screen md:h-screen md:overflow-hidden md:overflow-y-auto bg-[#1e1e2d] pt-14 md:pt-0 transition-all">
        <div className="floating-container p-7 md:p-8 animate-fade-in relative z-0 h-auto md:h-full overflow-x-hidden max-w-[100vw]">
