...
export const Layout: React.FC = () => {
  ...
  return (
    <div className="flex min-h-screen md:h-screen bg-[#1e1e2d]">
      ...
      <div className="md:hidden fixed top-0 left-0 w-screen bg-white z-[100] h-14 border-b border-gray-100 flex items-center justify-between px-4 transition-all duration-300 shadow-sm">
        {/* Left: Logo */}
